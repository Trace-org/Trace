    ...
    <form onSubmit={handleSubmit} className="w-full max-w-full mx-auto space-y-4">
      <div className="w-full bg-white rounded-lg shadow-lg p-4 relative">
        <div className="flex items-center space-x-3 pb-4">
          ...
          <div>
            <h2 className="text-trace-earth text-lg">Registro Empresarial</h2>
            <p className="text-sm">Completa el formulario para solicitar acceso</p>
          </div>
          <div className="absolute top-4 right-4"> {/* This div will push the button to the right */}
            <DialogCloseButton />
          </div>
        </div>
        ...
        <Button
          type="submit"
          className="w-full bg-trace-wallet hover:bg-trace-wallet-dark text-white font-medium py-2 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 mt-6"
        >
          Enviar Solicitud
        </Button>
      </div>
